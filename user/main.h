...
#define USER_FLASH_LAST_PAGE_ADDRESS        (ADDR_FLASH_PAGE_127)
#define USER_FLASH_END_ADDRESS              (ADDR_FLASH_PAGE_127 + FLASH_PAGE_SIZE)         /* 128 KBytes */

/* define the address from where user application will be loaded, the application address should be a start sector address */
#define APPLICATION_ADDRESS                 (ADDR_FLASH_PAGE_20)

/* Get the number of Sector from where the user program will be loaded */
#define FLASH_PAGE_NUMBER           (uint32)((APPLICATION_ADDRESS - ADDR_FLASH_PAGE_0) / FLASH_PAGE_SIZE)
 ...
 ****************************************************************************/
#define MOTOR_WARM_TICK                 50


#define STB_MaxTempH                    400                 // 加热周期
#define STB_MaxTempL                    1                   // 不加热周期


#define HZPrintSIZE                     2304                        // 48 * 48 = 2304
